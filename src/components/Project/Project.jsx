            ...
            <section className='project' ref={projectRef}>
                ...
                <div className='project__grid'>
                    <article className='project__item'>
                        <img className='project__item-thumbnail' src={projectImages.personal_project_01} alt="프로젝트 이미지" />
                        <h3 className='project__item-title'>개인 포트폴리오</h3>
                    ...
                    <article className='project__item'>
                        <img className='project__item-thumbnail' src={projectImages.team_project_03} alt="프로젝트 이미지" />
                    ...
                    <article className='project__item'>
                        <img className='project__item-thumbnail project__item-thumbnail--light' src={projectImages.team_project_02} alt="프로젝트 이미지" />
                    ...
                    <article className='project__item'>
                        <img className='project__item-thumbnail' src={projectImages.team_project_01} alt="프로젝트 이미지" />
