            ...
            <section className='project' ref={projectRef}>
                ...
                <div className='project__grid'>
                    <article className='project__item'>
                        ...
                        <h4 className='project__item-description'>(personal) 개인 포트폴리오 사이트</h4>
                    </article>
                    <article className='project__item'>
                        ...
                        <h4 className='project__item-description'>(team) 영화 OTT 사이트</h4>
                    </article>
                    <article className='project__item'>
                        ...
                        <h4 className='project__item-description'>(team) 여행 정보 사이트</h4>
                    </article>
                    <article className='project__item'>
                        ...
                        <h4 className='project__item-description'>(team) 향수 쇼핑몰 사이트</h4>
                    </article>
                </div>
            </section>
        </>
